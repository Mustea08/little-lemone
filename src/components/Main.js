    ...
    <main>
      ...
      <section className="about" id="about">
        <div className="contents">
          ...
          <h3>Cairo</h3>
          <p>
            little lemon website provide different types of foods and different
            types of drinks, welcome to our restaurant anytime. our restaurant
            is in st.34 downtown .our restaurant is in st.34 downtown
          </p>
        </div>
